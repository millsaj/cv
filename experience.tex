...
{\href{https://www.appt-health.co.uk/}{Appt Health}} {\textsc{London, United Kingdom}}
{
	...
	{
		\bodytext{Appt Health helps the NHS provide preventative healthcare by automating the call and recall process for patients. We have automated SMS and letter invitation channels, a GUI booking tool for staff calling patients over the phone and a small windows application built with Electron.
		
		As the lead developer at Appt Health since the project's inception, I have developed and maintained a software system that handles sensitive patient data and that integrates with several NHS APIs. The clinical risk involved required a rigorous approach to all aspects of development and testing.
		
		I've led and managed a small team of other developers; doing so has been an exciting challenge that has further developed my technical and interpersonal skills. It is my responsibility to set our software development standards, encourage and train other developers, manage our backlog and sprints, have the final say on large architectural or security decisions and evaluate new technical hires.}
		\inlineheadsection
		{Stack:} {C\# Dotnet Core, ASP.NET, Docker, FHIR, SOAP \& REST APIs, ABP Framework, DDD, BDD (XUnit, Specflow, Cypress), CI/CD (Azure Pipelines), Razor pages, Angular, Postgres, Git, Electron, WiX}
	}
}
...
{\href{https://theday.co.uk/}{The Day News \& Media}} {\textsc{London, United Kingdom}}
{
	...
	{Full Stack Developer} {July 2018 -- June 2020}
	{
		...
		\inlineheadsection
		{Stack:} {Ruby On Rails, PHP, Git, Docker, TDD (RSpec), CI/CD (CircleCI), AWS, Svelte, Sass, Elasticsearch, Redis, Postgres}
	}
}
